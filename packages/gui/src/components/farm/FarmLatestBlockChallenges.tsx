...
import { useGetSignagePointsQuery, useGetTotalHarvestersSummaryQuery } from '@bpx/api-react';
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption">
        <Trans>
          *Want to explore BPX’s blocks further? Check out{' '}
          <Link
            color="primary"
            href="https://alltheblocks.net/bpx"
            target="_blank"
          >
            All The Blocks
          </Link>{' '}
