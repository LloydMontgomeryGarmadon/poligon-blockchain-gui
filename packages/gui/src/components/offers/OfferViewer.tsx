...
import { useCheckOfferValidityMutation } from '@poligon/api-react';
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://alltheblocks.net/poligon/coin/${coin.parentCoinInfo}`,
                )
              }
            >
              {coin.parentCoinInfo}
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://alltheblocks.net/poligon/puzzlehash/${coin.puzzleHash}`,
                )
              }
            >
              {coin.puzzleHash}
