...
/*        An NFT offer consists of a single NFT being offered for BPX         */
/* ========================================================================== */
    ...
    >
      ...
      >
        <Tab
          ...
          label={<Trans>NFT for BPX</Trans>}
          disabled={disabled}
        />
        <Tab
          value={NFTOfferExchangeType.XCHForNFT}
          label={<Trans>BPX for NFT</Trans>}
          disabled={disabled}
        />
      </Tabs>
      <Grid container>
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*             Currently only supports a single NFT <--> BPX offer            */
/* ========================================================================== */
