...
/*        An NFT offer consists of a single NFT being offered for POL         */
/* ========================================================================== */
    ...
    >
      ...
      >
        <Tab
          ...
          label={<Trans>NFT for POL</Trans>}
          disabled={disabled}
        />
        <Tab
          value={NFTOfferExchangeType.XCHForNFT}
          label={<Trans>POL for NFT</Trans>}
          disabled={disabled}
        />
      </Tabs>
      <Grid container>
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*             Currently only supports a single NFT <--> POL offer            */
/* ========================================================================== */
