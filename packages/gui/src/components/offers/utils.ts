...
export function summaryStringsForNFTOffer(
  ...
  // TODO: Remove 1:1 NFT <--> BPX assumption
...
export function getNFTPriceWithoutRoyalties(
  ...
  // NFTs can only be exchanged for BPX currently
  const amountInMojos = offerAssetAmountForAssetId('bpx', summary);
