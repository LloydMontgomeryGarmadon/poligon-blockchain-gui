...
import { Button, CopyToClipboard, Card, Loading, Flex, TooltipIcon } from '@bpx/core';
import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@bpx/api-react';
import {
  Box,
  TextField,
  InputAdornment,
