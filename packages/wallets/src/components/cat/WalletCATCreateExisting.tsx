...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@cryptomines/core';
import { Box, Grid } from '@mui/material';
import { useDispatch } from 'react-redux';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router';
import { create_cc_for_colour_action } from '../../../modules/message';
import { chiaToMojo } from '@cryptomines/core';
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create Token Wallet from Existing Limiter</Trans>}
