...
import { Flex, Loading, useOpenDialog } from '@poligon/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@poligon/api-react';
import { Offers as OffersIcon } from '@poligon/icons';
