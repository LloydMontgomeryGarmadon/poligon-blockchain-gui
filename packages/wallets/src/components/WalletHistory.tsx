...
import { Card, CardKeyValue, CopyToClipboard, Flex, Loading, StateColor, TableControlled, toBech32m, useCurrencyCode, mojoToChiaLocaleString, mojoToCATLocaleString } from '@bpx/core';
import { useGetOfferRecordMutation, useGetSyncStatusQuery } from '@bpx/api-react';
import styled from 'styled-components';
import type { Row } from '@bpx/core';
import { WalletType, TransactionType } from '@bpx/api';
